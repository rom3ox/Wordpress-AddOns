...
When you display list posts in WordPress and want to display a snippet of the post content, there are two ways you can do this. You can either use the the_excerpt() function which will return the first 55 words of the post, excluding all shortcodes and images. The other option is to use the the_content() function with the more comment to tell WordPress to break at this point.
